...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpAr}\;{}\<[11]%
\>[11]{}\Conid{X}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}(i_2\comp i_1)\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}{}\<[26]%
\>[26]{}(i_2\comp i_2\comp i_1)\;(\Varid{op},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}{}\<[23]%
\>[23]{}(i_2\comp i_2\comp i_2)\;(\Varid{op},\Varid{a}){}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{x}\mathrel{=}\alt{\underline{\Varid{x}}}{\Varid{g1}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g1}\mathrel{=}\alt{\Varid{id}}{\Varid{ops}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{ops}\mathrel{=}\alt{\Varid{binOp}}{\Varid{unOp}}\;\mathbf{where}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Varid{binOp}\;(\Conid{Sum},\Varid{a})\mathrel{=}\uncurry{(\mathbin{+})}\;\Varid{a}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Varid{binOp}\;(\Conid{Product},\Varid{a})\mathrel{=}\uncurry{(\mathbin{*})}\;\Varid{a}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Varid{unOp}\;(\Conid{Negate},\Varid{a})\mathrel{=}\Varid{negate}\;\Varid{a}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Varid{unOp}\;(\Conid{E},\Varid{a})\mathrel{=}\Varid{expd}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{clean}\;\Conid{X}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{N}\;\Varid{a})\mathrel{=}(i_2\comp i_1)\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{b})\mathrel{=}(i_2\comp i_2\comp i_1)\;(\Conid{Sum},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{\vee}\Varid{b}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}(i_2\comp i_1)\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{otherwise}\mathrel{=}(i_2\comp i_2\comp i_1)\;(\Conid{Product},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{a})\mathrel{=}(i_2\comp i_2\comp i_2)\;(\Conid{Negate},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}(i_2\comp i_1)\;\mathrm{0}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{otherwise}\mathrel{=}(i_2\comp i_2\comp i_2)\;(\Conid{E},\Varid{a}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{gopt}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{b}+(\Varid{a}+((\Conid{BinOp},(\Varid{a},\Varid{a}))+(\Conid{UnOp},\Varid{a})))\to \Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{fvar}}{\alt{\Varid{fconst}}{\Varid{fops}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{fvar}\;\Varid{a}\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{fconst}\;\Varid{a}\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{fops}\mathrel{=}\alt{\Varid{fbinOp}}{\Varid{funOp}}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{fbinOp}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{c}),(\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{fbinOp}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{c}),(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{d})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{c}))){}\<[E]%
\\[\blanklineskip]%
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{funOp}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a},\Conid{Un}\;\Conid{Negate}\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{funOp}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{var}\mathrel{=}\alt{\conj{\underline{\Varid{var}}}{\underline{\mathrm{1}}}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g}\mathrel{=}\alt{\Varid{fcons}}{\Varid{fops}}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{fcons}\;\Varid{x}\mathrel{=}(\Varid{x},\mathrm{0}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{fops}\mathrel{=}\alt{\Varid{fbinOp}}{\Varid{funOp}}{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\mathbf{where}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{fbinOp}\;(\Conid{Sum},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\mathbin{+})\;\Varid{a}\;\Varid{c},(\mathbin{+})\;\Varid{b}\;\Varid{d}){}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{fbinOp}\;(\Conid{Product},((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})))\mathrel{=}((\mathbin{*})\;\Varid{a}\;\Varid{c},(\mathbin{+})\;((\mathbin{*})\;\Varid{a}\;\Varid{d})\;((\mathbin{*})\;\Varid{b}\;\Varid{c})){}\<[E]%
\\[\blanklineskip]%
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{funOp}\;(\Conid{Negate},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{negate}\;\Varid{a},\Varid{negate}\;\Varid{b}){}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{funOp}\;(\Conid{E},(\Varid{a},\Varid{b}))\mathrel{=}(\Varid{expd}\;\Varid{a},(\mathbin{*})\;(\Varid{expd}\;\Varid{a})\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{catal}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathbin{*})\;(\Varid{catal}\;\Varid{n})\;\Varid{f}\;\Varid{n}\div \Varid{k}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{f}\;\Varid{n})\mathbin{+}(\Varid{f2}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f2}\;\mathrm{0}\mathrel{=}\mathrm{10}{}\<[E]%
\\
\>[B]{}\Varid{f2}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{f2}\;\Varid{n})\mathbin{+}\mathrm{8}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{k}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{k}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{k}\;\Varid{n})\mathbin{+}(\Varid{k2}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{k2}\;\mathrm{0}\mathrel{=}\mathrm{4}{}\<[E]%
\\
\>[B]{}\Varid{k2}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{k2}\;\Varid{n})\mathbin{+}\mathrm{2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{catal},\Varid{f},\Varid{f2},\Varid{k},\Varid{k2})\mathrel{=}(\Varid{catal}\mathbin{*}\Varid{f}\div \Varid{k},\Varid{f}\mathbin{+}\Varid{f2},\Varid{f2}\mathbin{+}\mathrm{8},\Varid{k}\mathbin{+}\Varid{k2},\Varid{k2}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{10},\mathrm{2},\mathrm{4}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{catal},\Varid{f},\Varid{f2},\Varid{k},\Varid{k2})\mathrel{=}\Varid{catal}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\begin{eqnarray}
  C_n = \frac{(2n)!}{(n+1)!(n!)} \nonumber
\end{eqnarray}
Utilizamos a estratégia encontrada no anexo \ref{sec:recmul}, e começamos por calcular \ensuremath{\Conid{C}\;\mathrm{0}} e \ensuremath{\Conid{C}\;(\Varid{n}\mathbin{+}\mathrm{1})}
\begin{eqnarray}
  C_0 = 1 \nonumber
\end{eqnarray}
...
\end{eqnarray}
Ao contrário do exemplo encontrado no anexo \ref{sec:recmul} em que se obtinha \ensuremath{\Varid{e}\;\Varid{x}} e \ensuremath{\Varid{h}\;\Varid{x}} em recursividade
mútua, aqui é necessário definirmos duas funçoes á qual designaremos por \ensuremath{\Varid{f}} e \ensuremath{\Varid{k}} tal que :
...
E portanto obtemos \ensuremath{\Varid{f}\;\Varid{n}} , \ensuremath{\Varid{k}\;\Varid{n}} e \ensuremath{\Conid{C}\;\Varid{n}} em recursividade mútua.
...
Continuando a seguir o exemplo do anexo, repetimos agora o processo para \ensuremath{\Varid{f}} e \ensuremath{\Varid{k}}.

Para \ensuremath{\Varid{f}}:
\begin{eqnarray}
  f_0 = 2 \nonumber
\end{eqnarray}
...
Definindo \ensuremath{\Varid{f2}\;\Varid{n}} = \ensuremath{\mathrm{8}\;\Varid{n}\mathbin{+}\mathrm{10}}, obtemos:

\begin{eqnarray}
  f_{n+1} = f_n + f2_n \nonumber
\end{eqnarray}

Para \ensuremath{\Varid{k}}:
\begin{eqnarray}
  k_0 = 2 \nonumber
\end{eqnarray}
...
Definindo \ensuremath{\Varid{k2}\;\Varid{n}} = \ensuremath{\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{4}}, obtemos:
...
Desenvolvendo agora as funções \ensuremath{\Varid{f2}} e \ensuremath{\Varid{k2}}: 
...
Terminado este processo obtemos 5 funções ( \ensuremath{\Conid{C}}, \ensuremath{\Varid{f}}, \ensuremath{\Varid{f2}}, \ensuremath{\Varid{k}}, \ensuremath{\Varid{k2}}). Utilizamos agora a \emph{regra de algibeira} descrita no enunciado e sabemos que:
\begin{itemize}
\item	O corpo do ciclo \ensuremath{\Varid{loop}} terá 5 argumentos .
\item	As variáveis serão \ensuremath{\Conid{C}}, \ensuremath{\Varid{f}}, \ensuremath{\Varid{f2}}, \ensuremath{\Varid{k}} e \ensuremath{\Varid{k2}}.
\item	Os resultados são retirados das expressões respectivas, retirando a variável \ensuremath{\Varid{n}}. 
\end{itemize}
Com isto podemos finalmente escrever o nosso \ensuremath{\Varid{loop}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{catal},\Varid{f},\Varid{f2},\Varid{k},\Varid{k2})\mathrel{=}(\Varid{catal}\mathbin{*}\Varid{f}\div \Varid{k},\Varid{f}\mathbin{+}\Varid{f2},\Varid{f2}\mathbin{+}\mathrm{8},\Varid{k}\mathbin{+}\Varid{k2},\Varid{k2}\mathbin{+}\mathrm{2}){}\<[E]%
...
\begin{itemize}
\item	Em \ensuremath{\Varid{init}} coleccionam-se os resultados dos casos de base das funções \ensuremath{\Conid{C}}, \ensuremath{\Varid{f}}, \ensuremath{\Varid{f2}}, \ensuremath{\Varid{k}}, \ensuremath{\Varid{k2}}
\end{itemize}

Podemos concluir preenchendo o \ensuremath{\Varid{init}}:
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}\alt{\underline{\cdot }\mathbin{\$}\underline{\Varid{nil}}}{\Varid{k2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k2}\;(\Varid{q},\Varid{g})\;[\mskip1.5mu \mskip1.5mu]\;\Varid{f}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k2}\;(\Varid{q},\Varid{g})\;(\Varid{x}\mathbin{:}\Varid{xs})\;\Varid{f}\mathrel{=}\Varid{linear1d}\;\Varid{q}\;\Varid{x}\;\Varid{f}\mathbin{:}\Varid{g}\;\Varid{xs}\;\Varid{f}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mathbf{data}\;\Conid{AlgForm}\;\Varid{a}\mathrel{=}\Conid{Vazio}\mid \Conid{Unidade}\;\Varid{a}\mid \Conid{Par}\;(\Conid{AlgForm}\;\Varid{a})\;(\Conid{AlgForm}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{inALgForm}\mathrel{=}\alt{\underline{\Conid{Vazio}}}{\alt{\Conid{Unidade}}{\uncurry{\Conid{Par}}}}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{outAlgForm}\;\Conid{Vazio}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outAlgForm}\;(\Conid{Unidade}\;\Varid{a})\mathrel{=}(i_2\comp i_1)\;(\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outAlgForm}\;(\Conid{Par}\;\Varid{x}\;\Varid{y})\mathrel{=}(i_2\comp i_2)\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{fAlgForm}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{id}+(\Varid{g}\times\Varid{g})){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{anaAlgForm}\;\Varid{g}\mathrel{=}\Varid{inALgForm}\comp \Varid{fAlgForm}\;(\Varid{anaAlgForm}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{cataAlgForm}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{fAlgForm}\;(\Varid{cataAlgForm}\;\Varid{g})\comp \Varid{outAlgForm}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}(i_2\comp i_1)\;\Varid{p}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;\Varid{l}\mathrel{=}(i_2\comp i_2)\;(\Varid{init}\;\Varid{l},\Varid{tail}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}{}\<[9]%
\>[9]{}\mathrel{=}\alt{\Varid{a}}{\alt{\Varid{b}}{\Varid{c}}}\;\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\Varid{a}\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\Varid{b}\mathrel{=}\underline{\cdot }{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\Varid{c}\mathrel{=}\lambda (\Varid{p},\Varid{q})\to \lambda (\Varid{pt})\to (\Varid{calcLine}\;(\Varid{p}\;\Varid{pt})\;(\Varid{q}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{hyloAlgForm}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{cataAlgForm}\;\Varid{f}\comp \Varid{anaAlgForm}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{myListin}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{myListout}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{myListout}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{h},\Varid{t}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{cataMyList}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recMyList}\;(\Varid{cataMyList}\;\Varid{g})\comp \Varid{myListout}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{recMyList}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataMyList}\;\Varid{gene}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{h}}{\Varid{k}}}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{h}\;\Varid{a}\mathrel{=}(\mathbin{/})\;((\mathbin{+})\;(\p1\;\Varid{a})\;((\mathbin{*})\;((\p1\comp \p2)\;\Varid{a})\;((\p2\comp \p2)\;\Varid{a})))\;(\succ \mathbin{\$}(\p2\comp \p2)\;\Varid{a}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{k}\;\Varid{a}\mathrel{=}\succ \mathbin{\$}(\p2\comp \p2)\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
	\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\Varid{h}}{\Varid{k}}}}
%
\just\equiv{ Fokkinga }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\\\length \comp \mathbf{in}\mathrel{=}\Varid{k}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\end{lcbr}}
%
\just\equiv{ def-in, Funtor myList, h=[h1,h2], k=[k1,k2] }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \alt{\Varid{singl}}{\Varid{cons}}\mathrel{=}\alt{\Varid{h1}}{\Varid{h2}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\\\length \comp \alt{\Varid{singl}}{\Varid{cons}}\mathrel{=}\alt{\Varid{k1}}{\Varid{k2}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\end{lcbr}}
%
\just\equiv{ Fusão-+, Absorção-+, Natural-id }
%
        \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{singl},\Varid{avg}\comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp (\Varid{id}\times\conj{\Varid{avg}\;\length }{\cdot })}{\cdot }\\\alt{\length \comp \Varid{singl},\length \comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{k1},\Varid{k2}\comp (\Varid{id}\times\conj{\Varid{avg}\;\length }{\cdot })}{\cdot }\end{lcbr}}
%
\just\equiv{ Def-x, Natural-id }
%
        \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{singl},\Varid{avg}\comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp \conj{\p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }}{\cdot }\\\alt{\length \comp \Varid{singl},\length \comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{k1},\Varid{k2}\comp (\Varid{id}\times\conj{\Varid{avg}\;\length }{\cdot })}{\cdot }\end{lcbr}}
%
\just\equiv{ Fusão-x }
%
        \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{singl},\Varid{avg}\comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }}{\cdot }\\\alt{\length \comp \Varid{singl},\length \comp \Varid{cons}}{\cdot }\mathrel{=}\alt{\Varid{k1},\Varid{k2}\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }}{\cdot }\end{lcbr}}
%
\just\equiv{ Eq-+ }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \Varid{singl}\mathrel{=}\Varid{h1}\\\Varid{avg}\comp \Varid{cons}\mathrel{=}\Varid{h2}\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }\end{lcbr}}

        \ensuremath{\begin{lcbr}\length \comp \Varid{singl}\mathrel{=}\Varid{k1}\\\length \comp \Varid{cons}\mathrel{=}\Varid{k2}\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }\end{lcbr}}
%
\just\equiv{ def avg, def length }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \Varid{singl}\mathrel{=}\Varid{id}\\\Varid{avg}\comp \Varid{cons}\mathrel{=}((\p1\mathbin{+}((\p1\comp \p2)\mathbin{*}(\p2\comp \p2)))\mathbin{/}(\succ \comp \p2\comp \p2))\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }\end{lcbr}}

        \ensuremath{\begin{lcbr}\length \comp \Varid{singl}\mathrel{=}\underline{\mathrm{1}}\\\length \comp \Varid{cons}\mathrel{=}(\succ \comp \p2\comp \p2)\comp \conj{\Varid{avg}\comp \p2,\length \comp \p2}{\cdot }\end{lcbr}}
%
\just\equiv{ Invertendo até ao primeiro passo}
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \alt{\Varid{singl}\;\Varid{cons}}{\cdot }\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{avg}\;\length }{\cdot }\\\length \comp \alt{\Varid{singl}\;\Varid{cons}}{\cdot }\mathrel{=}\Varid{k}\comp \Conid{F}\;\conj{\Varid{avg}\;\length }{\cdot }\end{lcbr}}
%
\just\equiv{ Fokkinga }
%
      	\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\alt{\Varid{h1},\Varid{h2}}{\cdot },\alt{\Varid{k1},\Varid{k2}}{\cdot }}{\cdot }}}
%
\just\equiv{ lei da troca, def h1, def h2, def k1, def k2 }
%
       	\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\alt{\conj{\Varid{id},\underline{\mathrm{1}}}{\cdot },\conj{(\p1\mathbin{+}((\p1\comp \p2)\mathbin{*}(\p2\comp \p2)))\mathbin{/}(\succ \comp \p1\comp \p2),\succ \comp \p2\comp \p2}{\cdot }}{\cdot }}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{h}}{\Varid{k}}}{}\<[E]%
\\
\>[4]{}\hsindent{2}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\Varid{h}\;\Varid{a}\mathrel{=}(\mathbin{/})\;((\mathbin{+})\;((\mathbin{*})\;((\p1\comp \p1)\;\Varid{a})\;((\p2\comp \p1)\;\Varid{a}))\;((\mathbin{*})\;((\p1\comp \p2)\;\Varid{a})\;((\p2\comp \p2)\;\Varid{a})))\;((\mathbin{+})\;((\p2\comp \p1)\;\Varid{a})\;((\p2\comp \p2)\;\Varid{a})){}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\Varid{k}\;\Varid{a}\mathrel{=}(\mathbin{+})\;((\p2\comp \p1)\;\Varid{a})\;((\p2\comp \p2)\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\length \;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\length \;(\Conid{Fork}\;\Varid{a}\;\Varid{b})\mathrel{=}(\length \;\Varid{a})\mathbin{+}(\length \;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{avg}\;(\Conid{Fork}\;\Varid{a}\;\Varid{b})\mathrel{=}(\Varid{avg}\;\Varid{a}\mathbin{*}\length \;\Varid{a})\mathbin{+}(\Varid{avg}\;\Varid{b}\mathbin{*}\length \;\Varid{b})\mathbin{/}(\length \;\Varid{a}\mathbin{+}\length \;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\just\equiv{ def-in, Funtor myList, h=[h1,h2], k=[k1,k2] }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{h1}}{\Varid{h2}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })\\\length \comp \alt{\Conid{Leaf}}{\Conid{Fork}}\mathrel{=}\alt{\Varid{k1}}{\Varid{k2}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length })\end{lcbr}}
%
\just\equiv{ Fusão-+, Absorção-+, Natural-id }
%
        \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Conid{Leaf},\Varid{avg}\comp \Conid{Fork}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp (\conj{\Varid{avg}\;\length }{\cdot }\times\conj{\Varid{avg}\;\length }{\cdot })}{\cdot }\\\alt{\length \comp \Conid{Leaf},\length \comp \Conid{Fork}}{\cdot }\mathrel{=}\alt{\Varid{k1},\Varid{k2}\comp (\conj{\Varid{avg}\;\length }{\cdot }\times\conj{\Varid{avg}\;\length }{\cdot })}{\cdot }\end{lcbr}}
%
\just\equiv{ Def-x }
%
        \ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Conid{Leaf},\Varid{avg}\comp \Conid{Fork}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }}{\cdot }\\\alt{\length \comp \Conid{Leaf},\length \comp \Conid{Fork}}{\cdot }\mathrel{=}\alt{\Varid{h1},\Varid{h2}\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }}{\cdot }\end{lcbr}}
%
\just\equiv{ Eq-+ }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \Conid{Leaf}\mathrel{=}\Varid{h1}\\\Varid{avg}\comp \Conid{Fork}\mathrel{=}\Varid{h2}\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }\end{lcbr}}

        \ensuremath{\begin{lcbr}\length \comp \Conid{Leaf}\mathrel{=}\Varid{k1}\\\length \comp \Conid{Fork}\mathrel{=}\Varid{k2}\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }\end{lcbr}}
%
\just\equiv{ def avg, def length }
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \Conid{Leaf}\mathrel{=}\Varid{id}\\\Varid{avg}\comp \Conid{Fork}\mathrel{=}((\p1\comp \p1)\mathbin{*}(\p2\comp \p1)\mathbin{+}(\p2\comp \p2)\mathbin{*}(\p1\comp \p2))\mathbin{/}((\p2\comp \p1)\mathbin{+}(\p2\comp \p2))\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }\end{lcbr}}

        \ensuremath{\begin{lcbr}\length \comp \Conid{Leaf}\mathrel{=}\underline{\mathrm{1}}\\\length \comp \Conid{Fork}\mathrel{=}((\p2\comp \p1)\mathbin{+}(\p2\comp \p2))\comp \conj{\conj{\Varid{avg}\;\length }{\cdot }\comp \p1,\conj{\Varid{avg}\;\length }{\cdot }\comp \p2}{\cdot }\end{lcbr}}
%
\just\equiv{ Invertendo até ao primeiro passo}
%
        \ensuremath{\begin{lcbr}\Varid{avg}\comp \alt{\Conid{Leaf}\;\Conid{Fork}}{\cdot }\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{avg}\;\length }{\cdot }\\\length \comp \alt{\Conid{Leaf}\;\Conid{Fork}}{\cdot }\mathrel{=}\Varid{k}\comp \Conid{F}\;\conj{\Varid{avg}\;\length }{\cdot }\end{lcbr}}
%
\just\equiv{ Fokkinga }
%
      	\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\alt{\Varid{h1}\;\Varid{h2}}{\cdot },\alt{\Varid{k1}\;\Varid{k2}}{\cdot }}{\cdot }}}
...
\ttfamily ~\\
\ttfamily ~let~inLTree~x~\char61{}~either~\char40{}konst~Empty\char41{}~Node~x\\
\ttfamily ~\\
\ttfamily ~let~outLTree~x~\char61{}~match~x~with\\
...
\ttfamily ~\\
\ttfamily ~let~recBTree~f~\char61{}~baseBTree~id~g~~~~~~~~~\char47{}\char47{}~that~is\char58{}~~id~\char45{}\char124{}\char45{}~\char40{}f~\char62{}\char60{}~f\char41{}\\
\ttfamily ~\\
\ttfamily ~let~rec~cataBTree~a~\char61{}~g~\char60{}\char60{}~\char40{}recBTree~\char40{}cataBTree~g\char41{}\char41{}~\char60{}\char60{}~outBTree\\
\ttfamily ~\\
\ttfamily ~let~rec~anaBTree~f~\char61{}~inBTree~\char60{}\char60{}~\char40{}recBTree~\char40{}anaBTree~g\char41{}~\char41{}~\char60{}\char60{}~g\\
\ttfamily ~\\
\ttfamily ~let~hyloBTree~a~c~\char61{}~cataBTree~h~\char60{}\char60{}~anaBTree~g\\
\ttfamily ~\\
...
\ttfamily ~\\
\ttfamily ~let~fmap~f~\char61{}~anaBTree~\char40{}~baseBTree~f~id~\char60{}\char60{}~outBTree~\char41{}\\
\ttfamily ~\\
...
\ttfamily ~~~~~~~~~\char124{}\char40{}h~\char58{}\char58{}~t\char41{}~\char45{}\char62{}~let~\char40{}s\char44{}l\char41{}~\char61{}~part~\char40{}\char60{}h\char41{}~t~in~Right~\char40{}h\char44{}\char40{}s\char44{}l\char41{}\char41{}\\
\ttfamily ~\\
\ttfamily ~\char47{}\char47{}let~part~x~\char61{}~\char46{}\char46{}\char46{}\\
\ttfamily ~~~~~~~~~\\
...
\ttfamily ~\\
\ttfamily ~let~tunion\char40{}a\char44{}\char40{}l\char44{}r\char41{}\char41{}~x~\char61{}~union~\char40{}map~\char40{}\char40{}\char58{}\char41{}~a\char41{}\char41{}~l\char41{}~\char40{}map~\char40{}\char40{}\char58{}\char41{}~a\char41{}\char41{}~r\char41{}~\\
\ttfamily ~\\
...
\ttfamily ~~~~~~~~~~~~~\char124{}\char40{}d\char44{}n\char43{}1\char41{}~\char45{}\char62{}~Right~\char40{}\char40{}n\char44{}d\char41{}\char44{}\char40{}\char40{}not~d\char44{}n\char41{}\char44{}\char40{}not~d\char44{}n\char41{}\char41{}\char41{}\\
\ttfamily ~\\
